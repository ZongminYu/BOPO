...
class TSPTrainer:
    ...
    def _train_one_epoch(self, epoch):
        ...
        while episode < train_num_episode:
            ...
            score, loss = self._train_one_batch(batch_size, self.trainer_params['K'])
    ...
    def _train_one_batch(self, batch_size, k):
        ...
        prob_list = torch.zeros(size=(batch_size, self.env.sols_num, 0))
