...
result_folder = './result/' + process_start_time.strftime("%Y%m%d_%H%M%S") + '{tag}'
...
def create_logger(log_file=None):
    ...
    if 'tag' in log_file:
        log_file['filepath'] = log_file['filepath'].format(tag='_' + log_file['tag'])
    else:
        log_file['filepath'] = log_file['filepath'].format(tag='')
